...
namespace HotelProject.WebUI.Controllers
{
    public class AdminGuestController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("http://localhost:63512/api/Guest");
        ...
        public async Task<IActionResult> AddGuest(CreateGuestDto createGuestDto)
        {
            ...
            var responseMessage = await client.PostAsync("http://localhost:63512/api/Guest", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"http://localhost:63512/api/Guest/{id}");
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"http://localhost:63512/api/Guest/{id}");
        ...
        public async Task<IActionResult> UpdateGuest(UpdateGuestDto updateGuestDto)
        {
            ...
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var responseMessage = await client.PutAsync($"http://localhost:63512/api/Guest/", stringContent);
